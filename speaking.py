...
@router.post("/api/speaking/start")
...
@router.post("/api/speaking/finalize")
...
@router.post("/api/speaking/abort")
...
@router.get("/api/speaking/session/{session_id}")
...
@router.get("/api/speaking/session/{session_id}/result")
